...
option = '--port=%s --conf_file=%s --cpy_path=%s --srv_path=%s --pylib_path=%s' %(config['listen_port'][0], os.path.join(conf_path, 'user.conf'), os.path.join(src_path, 'bstrap/python'), os.path.join(src_path, 'user'), pylib_path)
print option
